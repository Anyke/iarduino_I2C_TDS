...
void setup(){                                     //
     ...
     Serial.print(" (1234 ppm). \r\n");           //
     delay(60000);                                //   Ждём 1 минуту.
     tds.setCalibration(1, 1234 );                //   Выполняем 1 стадию калибровки указав известную концентрацию 1 раствора (в примере 1234ppm ).
     ...
     Serial.print(" (4321 ppm). \r\n");           //
     delay(60000);                                //   Ждём 1 минуту.
     tds.setCalibration(2, 4321 );                //   Выполняем 2 стадию калибровки указав известную концентрацию 2 раствора (в примере 4321ppm ).
     delay(2000);                                 //   Ждём 2 секунды.
