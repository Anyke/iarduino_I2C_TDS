...
bool	iarduino_I2C_TDS::setPullI2C		(bool f){																			//	Параметр:				флаг подтяжки линий шины I2C.
			...
			//	Сохраняем получившееся значение в регистр «REG_BITS_0»:															//
				...
				return false;																									//	Возвращаем ошибку.
																																...
																																//
//		Получение частоты переменного тока используемого для измерения электрического сопротивления жидкости:					//	Возвращаемое значение:	частота переменного тока от 1 до 2000 Гц.
...
bool	iarduino_I2C_TDS::setFrequency		(uint16_t frequency){																//	Параметр:				частота от 50 до 500 Гц.
			if(valAddr){																										//	Если модуль был инициализирован, то ...
			//	Проверяем полученные данные:																					//
				if( (frequency<50) || (frequency>500) ){ return false; }														//	Значение параметра должно находиться в диапазоне от 50 до 500 Гц.
