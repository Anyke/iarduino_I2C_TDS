...
#endif																											//
																												//
#include		<iarduino_I2C_TDS_I2C.h>																		//	Подключаем файл iarduino_I2C_TDS_I2C.h - для работы с шиной I2C		(используя функции структуры iI2C)
																												//
...
class iarduino_I2C_TDS{																							//
	...
	/**	Пользовательские функции **/																			//
		...
		bool				setFrequency		(uint16_t			);											//	Объявляем  функцию установки    частоты переменного тока для измерений	(Параметр:  частота от 1 до 2000Гц).
		...
		bool				setRd				(float				);											//	Объявляем  функцию установки    общего сопротивления датчика			(Параметр:  сопротивление от 0 до 16'777,215 Ом).
